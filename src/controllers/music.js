...
exports.musics = async (req, res) => {
  try {
    ...
    musics = musics.map((item) => {
      return {
        ...item,
        attache: process.env.PATH_FILE_SONG + item.attache,
        thumbnail: process.env.PATH_THUMBNAIL + item.thumbnail,
      };
    });
...
exports.getMusic = async (req, res) => {
  ...
  try {
    ...
    data = {
      ...data,
      attache: process.env.PATH_FILE_SONG + data.attache,
      thumbnail: process.env.PATH_THUMBNAIL + data.thumbnail,
    };
